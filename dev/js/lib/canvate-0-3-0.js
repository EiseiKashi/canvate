...
function Canvate(element) {
    ...
    // ::: CANVATE WebGL::: //
    var CanvateWebGL = function(image){
        'use strict';
        var _self         = this;
        this.background   = null;
    ...
    var initializeWebGL = function(){
        ...
        for (var index = 0; index < length; ++index) {
            try {
                ...
                _context        = _mainCanvas.getContext(name, {
                                                                    debug:true
                                                                    /*
    ...
    var initializeFallback = function() {
        console.warn("WebGL is not supported, Canvate will run in fallback mode.");
        _mainCanvas             = element;
        _context                = _mainCanvas.getContext(D2);
        _mainCanvas.width       = _mainCanvas.width;
        _mainCanvas.height      = _mainCanvas.height;
